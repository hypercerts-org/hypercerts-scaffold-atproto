...
import { useRequestEmailConfirmationMutation } from "@/queries/auth/use-request-email-confirmation-mutation";
import { useConfirmEmailMutation } from "@/queries/auth/use-confirm-email-mutation";
...
export default function VerifyEmailForm({
  ...
  const handleConfirmSubmit = (e: FormEvent) => {
    ...
    confirmMutation.mutate(
      { email: initialEmail, token: token.trim() },
      {
        onSuccess: () => {
          setStep("success");
        },
